...
//                     password: "", // clear password always
//                 });
//             }
//         } catch (error) {
...
//         e.preventDefault();
//         try {
//             const res = await axios.put("http://localhost:3000/api/users/profile", user, {
//                 headers: {
//                     Authorization: `Bearer ${localStorage.getItem("pos-token")}`,
//                 },
//             });
        ...
        try {
            ...
            if (res.data.success) {
                setUser({
                    ...
                    address: res.data.user.address,
                    password: "",
                    role: res.data.user.role, // role set kar diya
                });
            }
        } catch (error) {
            console.error("Error fetching user profile:", error);
